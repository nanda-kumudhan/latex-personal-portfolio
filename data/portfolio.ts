...
export const skills = {
  ...
  frameworks: ['React', 'Node.js', 'Flask', 'FastAPI', 'Bootstrap', 'Tailwind', 'Spring Boot'],
  developerTools: ['Docker', 'Google Cloud Platform', 'Firebase', 'Supabase', 'Git', 'Github Actions', 'VS Code', 'Visual Studio', 'PyCharm', 'IntelliJ', 'Eclipse'],
